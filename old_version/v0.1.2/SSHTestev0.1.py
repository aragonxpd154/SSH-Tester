...
import tkinter # Necessario instalar --"install python3-tk package
from tkinter import * # ^^^
...
#Pacote HTMLParser-0.0.2 instalado # OBS VERIFICAÇÃO DO MODULO PRE INSTALADO PELO SISTEMA
import webbrowser #Ja instalado pelo sistema
import re
...
#arquivoimagem=("ico.ico")
gui.iconbitmap("@/usr/share/pixmaps/ssh-teste-xbm.xbm")
gui.resizable(0,0)
textoconsole1="######################### Inicializando SSH TESTE v0.1 "
multy=textoconsole1.ljust(500,"#")
print(multy)

gui.title("SSH Teste |v0.1|")
__version__ = 0.1
__date__    = "19-09-2016"
...
def consultaBD():
    ...
    #Icone do programa
    consultaBD.iconbitmap("@/usr/share/pixmaps/ssh-teste-xbm.xbm")
    ...
    def cons1():
        try:
            ...
            barradeprogresso.step(99.9999999999999)
...
""")
    ...
    def abrirpaginaweb():
        try:
            ...
            #ICONE
            abrirpagina.iconbitmap("@/usr/share/pixmaps/ssh-teste-xbm.xbm")
            class HTMLRender(Text, HTMLParser):
                # Aqui definimos as tags alinhadas:
                __inline = [ "b", "i", "strong" ]
                # Aqui definimos as tags que geram seus próprios blocos
...
def sobreDados():
    ...
    abresobre.geometry("450x500")
    abresobre.title("Sobre")
    #ICONE
    abresobre.iconbitmap("@/usr/share/pixmaps/ssh-teste-xbm.xbm")
    ...
    filenameBase64=("""
""")
    ...
    #abresobre.attributes("-toolwindow", 0)
...
def contassalvaslog():
    ...
    #ICONE
    ContasLog.iconbitmap("@/usr/share/pixmaps/ssh-teste-xbm.xbm")
    class HTMLRender(Text, HTMLParser):
        # Aqui definimos as tags alinhadas:
        __inline = [ "b", "i", "strong" ]
        # Aqui definimos as tags que geram seus próprios blocos
...
def incluirDB():
    ...
    janelaincluir.geometry("450x500")
    ...
    janelaincluir.iconbitmap("@/usr/share/pixmaps/ssh-teste-xbm.xbm")
